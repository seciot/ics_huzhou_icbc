 ...
 * 发送交易数据条数
 */
public class CmdSendDataCount_S2C extends TcpCmdHead {

	private int dataCount;//登录结果
	
	public CmdSendDataCount_S2C() {
		super();
		this.dataCount = 0;
		this.setCmdLen(ConstDefine.MIN_CMD_LENGTH - 2 + 4);
		this.setCmdFlag(ConstDefine.CMD_SEND_DATACOUNT);
	}
